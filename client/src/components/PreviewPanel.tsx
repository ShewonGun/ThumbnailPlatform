            ...
            {isLoading && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xs mt-1 text-zinc-400">This may take 10-20 seconds.</p>
                    </div>
                </div>
            )}
            ...
            {!isLoading && thumbnail?.image_url && (
                <div className="group relative h-full w-full">
                    ...
                    <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                        <button onClick={onDownload} className="mb-6 flex items-center gap-2 rounded-md px-5 py-2.5 text-xs font-medium transition bg-white/30 ring-2 ring-white/40 backdrop-blur hover:scale-105 active:scale-95" type="button">
            ...
            {!isLoading && !thumbnail?.image_url && (
                <div className="absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25">
                    ...
                    <div className="px-4 text-center">
                        ...
                        <p className="mt-2 text-xs text-zinc-400">Fill out the form to get started.</p>
                    </div>
                </div>
            )}
        </div>
